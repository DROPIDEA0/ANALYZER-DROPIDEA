...
try {
    ...
    $migrationsSql = "INSERT INTO migrations (id, migration, batch) VALUES 
    ...
    // Insert user data
    $userSql = "INSERT INTO users (id, name, email, email_verified_at, password, remember_token, created_at, updated_at) VALUES 
    ...
    $apiKeySql = "INSERT INTO ai_api_settings (id, user_id, provider, api_key, api_base_url, model, is_active, settings, created_at, updated_at) VALUES 
    ...
    $pdo->exec($apiKeySql);
    echo "Inserted AI API settings.\n";

    // Insert sample website analyses data
    $analysesSql = "INSERT INTO website_analyses (id, user_id, url, region, analysis_type, analysis_data, seo_score, performance_score, load_time, ai_score, created_at, updated_at) VALUES 
    ...
    $pdo->exec($analysesSql);
    echo "Inserted website analysis data.\n";

    echo "\n✅ Database setup completed successfully!\n";
    echo "✅ All tables created\n";
    echo "✅ Sample data imported\n";
    echo "✅ User account: diaa.uddin.cv@gmail.com\n";
    echo "✅ 3 website analysis records imported\n";
    echo "✅ AI API settings configured\n";
